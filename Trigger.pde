class Trigger {
  ...
  String [] Parameter = {"/Radius Gear 0", "/Radius Gear 1", "/Radius Gear 2", "/Radius Gear 3", "/Petals_1", "/Petals_2", "/Petals_3", "/LineX", "/LineY"}; 
  String [] GearVars = {"RX", "RY", "P"};
  String [] LayerVars = {"LX", "LY"};
  ...
  void AniType() {
    if (LayerParameter <= 11) {
      ...
      ani = Ani.to(layer_1, aniDuration, LayerVars[LV], aniValue, easings[int(gui.cp5.getController("Easing"+"0"+Start+"0"+LayerParameter).getValue())]);
    }
  }
