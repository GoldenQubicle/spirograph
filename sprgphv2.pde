/* //<>//
 ...
 SO. . when the buttonbar (or possibly another radiobutton?) is toggled the keyFrame layer object is being drawn.. 
 HOWEVER there needs to be some parrallel stucture because layerswitching / copying etc, i.e. needs to be reference same object over time
 THAT SAID, ofc I want update gui between keyFrames now as well
 
 layerFrames.get(buttonbarID).display();
...
ArrayList<Layer> layerFrames = new ArrayList();
boolean play, update;
int Width = 512;
int Height = 512;
color cBackground;
